...
<head>
  ...
  <title>Welcome back<?php  $results=mysqli_query($base,"SELECT count(*) as total from messages where $_SESSION[id]=id_destinataire and trash=0 and lu=0");
          ...
          <aside class="mid-side">
			<div class="col-lg-12">
			  ...
			  <audio autoplay id="myaudio" >
						<source src="sounds/wb.ogg" type="audio/ogg">
					</audio>
                        <script>
