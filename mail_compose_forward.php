...
if ($nb == 0) {
	...
	<!--Pour : <select name="destinataire"!-->
                ...
                <div class="compose-mail">
                  <form role="form-horizontal"  action="mail_compose_forward.php" method="post">
                    ...
                    <div class="compose-editor">
                      <textarea class="wysihtml5 form-control" rows="9" name="message"><?php if (isset($_GET['message'])) echo stripslashes(htmlentities(trim($_GET['message']))); ?></textarea>
