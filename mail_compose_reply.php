...
if (isset($_POST['goo']) && $_POST['goo'] == 'Envoyer') {
...
if ($nb == 0) {
	...
	<!--Pour : <select name="destinataire"!-->
                ...
                <div class="compose-mail">
                  <form role="form-horizontal"  action="mail_compose_reply.php" method="post">
                    <div class="form-group">
					  ...
					  <?php   
						...
						echo '<option value="' , $_GET['id_destinataire'] , '" selected >' , stripslashes(htmlentities(trim($_GET['nom_destinataire']))) , '</option>';
						}
						?> 
                      </select>
					  </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" tabindex="1" id="subject" class="form-control" name="titre" value="<?php if (isset($_GET['titre'])) echo stripslashes(htmlentities(trim($_GET['titre']))); ?>">
                    </div>
                    ...
                    <div class="compose-btn">
                      ...
                      <button class="btn btn-sm" id="envoyer" name="goo" value="Envoyer" ><i class="fa fa-check"></i> Send</button>
