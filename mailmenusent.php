          ...
          ?>
                  ...
                  <li class="active"><a href="sent.php" class="active"> <i class="fa fa-envelope-o"></i> Sent Mails <span class="label label-theme pull-right inbox-notification"><?php echo "$datsent[total]" ?></span></a></li>
                  </li>
                  <li><a href="trash.php"> <i class="fa fa-trash-o"></i> Trash <span class="label label-theme pull-right inbox-notification"><?php echo "$c" ?></span></a></li>
                </ul>
              </div>
            </section>